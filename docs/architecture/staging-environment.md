...
| `https-dns` | 現行の既定（Issue #94 / #232、Terraform 変数の既定値も統一） | `ticket-api-staging.ticket-c2c.click`、ACM DNS 検証、ALB HTTPS listener、Route53 alias（HTTP は 301 リダイレクト） | `https://ticket-api-staging.ticket-c2c.click` |
